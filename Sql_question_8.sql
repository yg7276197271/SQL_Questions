...
Insert into Employees values (7, 'Yogesh', 1, 1)
...
-----Department  with highest no of employees 
select TOP 1 d.departmentName   from Employees e INNER JOIN Departments d
